#if DEBUG
// Project: SpeedyRacer, File: TestGame.cs
// Namespace: SpeedyRacer.Graphics, Class: TestGame
...
namespace SpeedyRacer.Graphics
{
	...
	/// Test game
	/// </summary>
	public partial class TestGame : SpeedyRacerManager//BaseGame
	{
		#region Variables
		/// <summary>
		/// Init code
		...
		protected override void Initialize()
		{
			...
			SpeedyRacerManager.Player.FreeCamera = true;
		...
		{
			// Don't handle SpeedyRacer.Render, which handles the game screens.
