// Project: SpeedyRacer, File: Model.cs
// Namespace: SpeedyRacer.Graphics, Class: Model
		...
		static public void TestRenderModel()
		{
			...
			TestGame.Start(
				delegate
				{
					...
					testModels.Add(new Model("SpeedyRacer"));
				},
				delegate
				{
					TrackLine.ShowGroundGrid();
					if (testModels[modelNum].name == "SpeedyRacer")
						testModels[modelNum].RenderCar(false, Matrix.Identity);
					else
		...
		public static void TestManyModelsPerformance()
		{
			...
			TestGame.Start("TestManyModelsPerformance",
				delegate
				{
					...
					SpeedyRacerManager.Player.SetCarPosition(Vector3.Zero,
				...
				delegate
				{
					...
					TextureFont.WriteText(2, 30,
						...
						testModels[0].NumOfMeshParts*(GridWidth*GridHeight)+" meshes.");
				});
