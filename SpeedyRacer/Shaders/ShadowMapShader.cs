// Project: SpeedyRacer, File: ShadowMapShader.cs
// Namespace: SpeedyRacer.Shaders, Class: ShadowMapShader
	...
	public class ShadowMapShader : ShaderEffect
	{
		...
		private void CalcSimpleDirectionalShadowMappingMatrix()
		{
			...
			Vector3 lightLookPos =
				SpeedyRacerManager.InMenu ? SpeedyRacerManager.Player.CarPosition :
				SpeedyRacerManager.Player.CarPosition +
				SpeedyRacerManager.Player.CarDirection * virtualVisibleRange / 6;
