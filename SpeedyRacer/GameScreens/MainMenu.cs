// Project: SpeedyRacer, File: MainMenu.cs
// Namespace: SpeedyRacer.GameScreens, Class: MainMenu
...
namespace SpeedyRacer.GameScreens
{
	...
	class MainMenu : IGameScreen
	{
		...
		public bool Render()
		{
			...
			// Write some text about this version
			TextureFont.WriteTextCentered(
				BaseGame.Width / 2, BaseGame.Height * 5 / 6,
				"First Mod of the Racing Game :)");
				...
				Input.KeyboardSpaceJustPressed)
			{
				...
				{
					case 0:
						SpeedyRacerManager.AddGameScreen(new GameScreen());
						break;
					case 1:
						SpeedyRacerManager.AddGameScreen(new Highscores());
						break;
					case 2:
						SpeedyRacerManager.AddGameScreen(new Options());
						break;
					case 3:
						SpeedyRacerManager.AddGameScreen(new Help());
						break;
					case 4:
						SpeedyRacerManager.AddGameScreen(new Credits());
						break;
					case 5:
						// Exit
						return true;
