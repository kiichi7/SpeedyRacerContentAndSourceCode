// Project: SpeedyRacer, File: Sound.cs
// Namespace: SpeedyRacer.Sounds, Class: Sound
// Path: C:\code\SpeedyRacer\Sounds, Author: Abi
	...
	class Sound
	{
		...
		static Sound()
		{
			try
			{
				...
				audioEngine = new AudioEngine(
					Path.Combine(dir, "SpeedyRacer.xgs"));
			...
			float speed, float speedChange, float rotationChange)
		{
			...
			if (brakeSoundStillPlayingMs <= 0 &&
				...
				SpeedyRacerManager.InMenu == false)
			{
