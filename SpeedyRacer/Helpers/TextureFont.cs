// Project: XnaTetris, File: TextureFont.cs
// Namespace: XnaTetris.Graphics, Class: TextureFont
// Path: C:\code\XnaTetris\Graphics, Author: Abi
...
namespace XnaTetris.Graphics
{
	...
	/// </summary>
	public class TextureFont //obs: : IDisposable
	{
		#region Constants
		/// <summary>
		...
		/// Create texture font
		/// </summary>
		public TextureFont(GraphicsDevice device)
		{
			fontTexture = Texture2D.FromFile(device, GameFontFilename);
			...
			for (int textNum = 0; textNum < remTexts.Count; textNum++)
			{
				...
				for (int num = 0; num < chars.Length; num++)
				{
						...
						charNum - 32 < CharRects.Length)
					{
						...
						//TODO: if we want upscaling, just use destRect
						fontSprite.Draw(fontTexture, //obs:destRect,
