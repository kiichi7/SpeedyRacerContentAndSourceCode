// Project: SpeedyRacer, File: Player.cs
// Namespace: SpeedyRacer.GameLogic, Class: Player
...
namespace SpeedyRacer.GameLogic
{
	...
	/// Note: This class is just used in SpeedyRacer and we only have
	...
	public class Player : ChaseCamera
	{
		...
		/// </summary>
		private float inAirTimeoutMilliseconds = 0.0f;
		#endregion
		...
		public override void Update()
		{
				...
				ZoomInTime <= 0)
			{
				...
				if (trackDistance > 24 ||
					inAirTimeoutMilliseconds > 500.0f)//5)
				{
