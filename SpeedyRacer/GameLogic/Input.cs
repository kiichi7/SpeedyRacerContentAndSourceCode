// Project: SpeedyRacer, File: Input.cs
// Namespace: SpeedyRacer.GameLogic, Class: Input
...
namespace SpeedyRacer.GameLogic
{
	...
	class Input
	{
		...
		/// Keyboard.GetState() the old state gets useless. We store our own
		/// array of keys from the last frame for comparing stuff.
		/// </summary>
		...
		/// <summary>
		/// Mouse wheel delta this frame. We don't know the total
		...
		internal static void Update()
		{
			...
			if (SpeedyRacerManager.InMenu == false &&
				// App must be active
				SpeedyRacerManager.IsAppActive)
			{
