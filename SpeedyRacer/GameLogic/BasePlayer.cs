// Project: SpeedyRacer, File: BasePlayer.cs
// Namespace: SpeedyRacer.GameLogic, Class: BasePlayer
...
namespace SpeedyRacer.GameLogic
{
	...
	public class BasePlayer
	{
		...
		protected void StartNewLap()
		{
			...
			SpeedyRacerManager.Landscape.StartNewLap();
		...
		public void SetGameOverAndUploadHighscore()
		{
			...
			if (alreadyUploadedHighscore == false)
			{
				...
				Highscores.SetHighscore((int)currentGameTimeMilliseconds);
