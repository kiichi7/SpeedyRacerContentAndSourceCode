// Project: SpeedyRacer, File: Replay.cs
// Namespace: SpeedyRacer.GameLogic, Class: Replay
...
namespace SpeedyRacer.GameLogic
{
	...
	public class Replay
	{
		...
		/// </summary>
		static readonly string ReplayFilename = "TrackSimple.Replay";
		#endregion
